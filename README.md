...
基于火山引擎API的AI视频生成客户端，支持单图音频驱动视频生成、视频改口型、即梦AI数字人生成和创意特效视频生成。
...
### 3. 即梦AI数字人生成
基于即梦AI OmniHuman技术的数字人视频生成，支持两个版本：1.0版本（主体识别+视频生成）和1.5版本（主体识别+对象检测+视频生成）。支持提示词控制、多主体指定、情感表演、宠物/动漫形象等功能。
